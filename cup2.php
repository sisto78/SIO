...
<body>
	...
	<form>
		...
		<div class="row">
			...
			<div class="col-md-4 mb-3">
				...
				<div class="form-group">
					<label style="font-weight: bold" for="exampleFormControlSelect2">SELEZIONA IL TIPO DI ESAME</label>
		...
		<div class="row">
			<div class="col-md-4 mb-3">
				<label style="font-weight: bold" for="validationDefault01">DATA DI PRENOTAZIONE</label>
				<input class="form-control" id="validationDefault01"id="date" type="date">
			</div>
			<div class="col-md-4 mb-3">

				<div class="form-group">
					<label style="font-weight: bold" for="exampleFormControlSelect2">STRUTTURA OSPEDALIERA</label>
					<select  class="form-control" id="exampleFormControlSelect2">
