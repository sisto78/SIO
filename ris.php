...
<body>
	...
	<body>
		...
		<form>
			...
			<div class="row">
				...
				<div class="col-md-4 mb-3">
					...
					<div class="form-group">
						<label for="exampleFormControlSelect2">ESAME EFFETTUATO</label>
			...
			<div class="row">
<div class="col-md-4 mb-3">
					<label for="validationDefault01">DATA ESECUZIONE ESAME</label>
					<input class="form-control" id="validationDefault01"id="date" type="date">
				</div>
				<div class="col-md-4 mb-3">

					<label for="image_uploads">INSERISCI IMMAGINE</label>
					<input type="file" id="image_uploads" name="image_uploads" accept=".jpg, .jpeg, .png" multiple>
				</div>
				<div class="col-md-4 mb-3">

					<label for="image_uploads">INSERISCI REFERTO</label>
